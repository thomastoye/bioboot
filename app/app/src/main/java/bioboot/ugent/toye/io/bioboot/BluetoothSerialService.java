...
// Adapted from https://github.com/johnhowe/BlueTerm/blob/master/src/es/pymasde/blueterm/BluetoothSerialService.java
...
import static bioboot.ugent.toye.io.bioboot.MainActivity.*;
...
public class BluetoothSerialService {
    ...
    private static final UUID SerialPortServiceClass_UUID = BLUETOOTH_CONNECTION_UUID;
